...
class PresentationUploader extends Component {
  ...
  handleFiledrop = files => {
	...
	console.log('PARAM=>', params.sessionToken , typeof params.sessionToken)
  ...
  const uploaders = files.map(file => {
    ...
    return axios.post("http://localhost:3030/api/imageProcessor/upload", formData, {
